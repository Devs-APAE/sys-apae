...
class AppointmentList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $appointment_type= new TDBCombo('appointment_type_id', 'app', 'AppointmentType', 'id', 'name');
    ...
    public function onClear($param): void
    {
    ...
    public function onSearch(): void
    {
        ...
        $filters = [];
        if ($data->patient_id) {
            $filters[] = new TFilter('patient_id', 'like', "%{$data->patient_id}%");
        }
    ...
    public function displayColumnDelete($object): bool
    {
        return  true;
    }
    ...
    public static function Delete($param): void
    {
        try{
            $key = $param['key'];
            TTransaction::open('app');
